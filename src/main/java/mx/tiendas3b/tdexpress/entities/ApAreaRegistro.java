...
/**
 * ApAreaRegistro generated by hbm2java
 */
@Entity
@Table(name = "ap_area_registro", catalog = "itaid")
public class ApAreaRegistro implements java.io.Serializable {
	...
	public ApAreaRegistro() {
	}

	public ApAreaRegistro(int soId, int areaId, int apId, int usuarioup, Date fechaup, int usuariocharge,
