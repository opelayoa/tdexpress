...
/**
 * AplicacionRegistro generated by hbm2java
 */
@Entity
@Table(name = "aplicacion_registro", catalog = "itaid")
public class AplicacionRegistro implements java.io.Serializable {
	...
	public AplicacionRegistro(String nombre, String descripcion, int usuarioup, Date fechaup, int usuariocharge,
