...
/**
 * CelularRegistro generated by hbm2java
 */
@Entity
@Table(name = "celular_registro", catalog = "itaid")
public class CelularRegistro implements java.io.Serializable {
	...
	public CelularRegistro() {
	}

	public CelularRegistro(String nombre, int region, String puesto, String area, String tipoSolicitud, int usuarioup,
	...
	public CelularRegistro(Integer ticketId, String nombre, int region, String puesto, String area,
			String tipoSolicitud, int usuarioup, Date fechaup, int usuariocharge, Date fechacharge, int usuariovobo,
