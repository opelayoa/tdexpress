...
/**
 * EprojectProyectoTiposTmp generated by hbm2java
 */
@Entity
@Table(name = "eproject_proyecto_tipos_tmp", catalog = "itaid")
public class EprojectProyectoTiposTmp implements java.io.Serializable {
	...
	public EprojectProyectoTiposTmp() {
	}

	public EprojectProyectoTiposTmp(int ptproyectoId, int pttuId, int usercreate, String status) {
	...
	public EprojectProyectoTiposTmp(int ptproyectoId, int pttuId, int usercreate, Date fechacreate, Integer usermod,
	...
	@Column(name = "fechacreate", length = 10)
