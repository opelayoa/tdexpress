...
/**
 * UnicoEventos generated by hbm2java
 */
@Entity
@Table(name = "unico_eventos", catalog = "itaid")
public class UnicoEventos implements java.io.Serializable {
	...
	public UnicoEventos(int headerEventoId, Date fechaInicio, Date fechaFin, Date fechahora, boolean status) {
