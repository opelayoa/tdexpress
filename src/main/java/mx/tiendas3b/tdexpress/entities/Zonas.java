 ...
 */
@Entity
@Table(name = "zonas", catalog = "itaid")
public class Zonas implements java.io.Serializable {
	...
	public Zonas(String nombre, String clave, String descripcion, int responsableId, Date dateCreate, int userCreate,
			Date dateModify, int userModify, boolean status) {
		this.nombre = nombre;
		this.clave = clave;
