...
/**
 * DeptoSintomaDiagnostico generated by hbm2java
 */
@Entity
@Table(name = "depto_sintoma_diagnostico", catalog = "itaid")
public class DeptoSintomaDiagnostico implements java.io.Serializable {
	...
	public DeptoSintomaDiagnostico(int deptoId, int sdId, int userreg, Date fechareg, int userdel, Date fechadel,
			boolean status) {
