...
/**
 * Table6Id generated by hbm2java
 */
@Embeddable
public class Table6Id implements java.io.Serializable {
	...
	public Table6Id(Integer idCategoria, String categoria, String idModelo, String modelo, String marca, String serie,
			String tagCpu, String usuario, String departamento, String usuarioId) {
	...
	@Column(name = "Categoria", length = 11)
	...
	@Column(name = "Id Modelo", length = 3)
	...
	@Column(name = "Departamento", length = 16)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Table6Id))
			return false;
		Table6Id castOther = (Table6Id) other;
