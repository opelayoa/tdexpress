...
/**
 * UsuarioTmp generated by hbm2java
 */
@Entity
@Table(name = "usuario_tmp", catalog = "itaid")
public class UsuarioTmp implements java.io.Serializable {
	...
	public UsuarioTmp(int id, String apellido, String nombre, String login, String password, String email,
			String celular, int departamentoId, int sucursalId, int perfilId, boolean envioCorreo, int userId,
			boolean emailEvento) {
		this.id = id;
	...
	public UsuarioTmp(int id, String apellido, String nombre, String login, String password, String email,
			String celular, String alias, int departamentoId, int sucursalId, int perfilId, boolean envioCorreo,
			Integer userGasto, Integer userCreate, Date dateCreate, Integer userModify, Date dateModify, int userId,
			Boolean status, boolean emailEvento, Integer puestoId) {
		this.id = id;
		this.apellido = apellido;
		this.nombre = nombre;
		this.login = login;
